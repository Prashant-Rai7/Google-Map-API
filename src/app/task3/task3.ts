...
//         console.log('entered inside if OK.status.....',status)
//         console.log('entered inside if OKresults......',results)
//         let val = this.logPolygonCoordinates(this.polygon)
//         console.log(val)
//         console.log(this.logPolygonCoordinates(this.polygon))
